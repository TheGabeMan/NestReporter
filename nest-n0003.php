<?php
    ...
    if (mysqli_connect_errno())
        ...
        $sql = "SELECT * FROM (SELECT timestamp, NestCurrentKelvin, NestTargetKelvin, WeatherTempKelvin, NestHeating FROM  `rawdata` ORDER BY  `rawdata`.`timestamp` DESC LIMIT 576) AS ttbl ORDER BY `timestamp` ASC;";
