...
?>
    ...
    <!-- Body Section -->
    <div id="nails-body">
        <a href="index.php?page=n0201"><div class="nails-menu-buttons" style="width:90%;margin-left: auto;margin-right: auto;display: block;">Search nail polish</div></a>
        <div class ="white-space-block" style="height:5px;"></div>
        <a href="index.php?page=n0301"><div class="nails-menu-buttons" style="width:90%;margin-left: auto;margin-right: auto;display: block;">Browse lists</div></a>
        <div class ="white-space-block" style="height:5px;"></div>
